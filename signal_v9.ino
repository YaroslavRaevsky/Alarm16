...
hub.WidgetSize(70);
hub.Label_(F("Bat"), "Уровень заряда аккумулятора", F("."), GH_DEFAULT, 30);
hub.WidgetSize(30);
hub.Label_(F("Bat_lvl"), "100 %", F("."), GH_DEFAULT, 30);
hub.WidgetSize(70);
hub.Label_(F("Charge"), "Наличие питания от сети", F("."), GH_DEFAULT, 30);
hub.WidgetSize(30);
hub.Label_(F("Charge_flag"), "Да", F("."), GH_DEFAULT, 30);
}
...
if (alarm1 == 0&&alarm2 == 0&&alarm3 == 0&&alarm4 == 0&&alarm5 == 0&&alarm6 == 0&&alarm7 == 0&&alarm8 == 0&&alarm9 == 0&&alarm10 == 0&&alarm11 == 0&&alarm12 == 0&&alarm13 == 0&&alarm14 == 0&&alarm15 == 0&&alarm16 == 0){
      AlarmFlag = 0;
}
    ...
    batValue100 = map(batValue, 1450, 2250, 1, 100);
    if(batValue100 > 100)
    {
      batValue100 = 100;
    }
...
// for (int count = 0; count < 10000; count++){
  ...
  {
  sprintf(str, "%Да"); // %d используется для форматирования целочисленного значения, %% используется для вывода символа %
  }
  hub.sendUpdate("Charge_flag", str);
